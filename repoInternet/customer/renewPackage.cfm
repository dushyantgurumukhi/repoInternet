			 			...
			 			<div class="panel-body">
							<cfif (isDefined("session.userid") and session.userid neq "") and isDefined("session.logintype") and session.logintype neq "">
								<form id="renew_package_form">
					    			<div class="row">
					    				<div class="col-xs-6 col-sm-6 col-md-6">
					    					<div class="form-group">
					                			...
					                			<input name="hidden_packageId" id="hidden_packageId" type="hidden"> 
					                			<input name="hidden_packageRenewDate" id="hidden_packageRenewDate" type="hidden">
					                			<input name="hidden_packageLastExpiredDate" id="hidden_packageLastExpiredDate" type="hidden">
					                			<input name="hidden_packageCurrExpiredDate" id="hidden_packageCurrExpiredDate" type="hidden">
					                			<input name="hidden_packageDuration" id="hidden_packageDuration" type="hidden" value="30">
					    					</div>
					    				</div>
					    				<div class="col-xs-6 col-sm-6 col-md-6">
					    					<div class="form-group">
					    			...
					    			<div id="renew_div" style="visibility:hidden">
										<div class="row">
						    				<div class="col-xs-6 col-sm-6 col-md-6">
						    					<div class="form-group">
